export default function Contact() {
  return (
    <section className="py-32 px-6 bg-slate-100 dark:bg-[#0d141b] relative transition-colors duration-200" id="contact">
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          <a
            ...
            href="mailto:hophihunghh123@gmail.com"
          >
            <span className="material-symbols-outlined">mail</span>
            hophihunghh123@gmail.com
          </a>
          <a
            className="flex items-center justify-center gap-2 px-8 py-4 bg-transparent border border-slate-300 dark:border-white/20 text-slate-900 dark:text-white rounded-lg font-bold text-lg hover:bg-slate-200/80 dark:hover:bg-white/5 transition-all"
            href="/resume"
          >
        ...
        <div className="flex items-center gap-8 mt-16 pt-16 border-t border-slate-200 dark:border-white/5 w-full justify-center">
          <a
            aria-label="LinkedIn"
          ...
          <a aria-label="Dribbble" className="text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors p-2" href="#">
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a aria-label="Twitter" className="text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors p-2" href="#">
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
            </svg>
          </a>
        </div>
        <p className="text-slate-500 dark:text-slate-600 text-sm">© 2024 Alex Design. All rights reserved.</p>
      </div>
    </section>
  )
}
