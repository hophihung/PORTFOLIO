...
const LIVE_DEMO_URL = 'https://japalyze-web.vercel.app/'
const GITHUB_URL = 'https://github.com/kietnguyen767/JapalyzeFe'

const features = [
  {
    icon: 'forum',
    title: 'AI Role-play (/roleplay)',
    desc: 'Môi trường hội thoại giả lập với AI, phản hồi tự nhiên theo ngữ cảnh.',
  },
  {
    icon: 'psychology',
    title: 'Smart Analysis (/api/ai)',
    desc: 'Phân tích sâu ngữ pháp, từ vựng và ngữ cảnh của câu văn bất kỳ.',
  },
  {
    icon: 'style',
    title: 'Auto Flashcards',
    desc: 'Tự động trích xuất từ vựng quan trọng từ bài học để tạo bộ ôn tập.',
  },
  {
    icon: 'architecture',
    title: 'Modern Architecture',
    desc: 'Sử dụng Next.js App Router mới nhất để tối ưu Routing và Data Fetching.',
  },
]

const folderStructure = `japalyze/
├── app/               # Next.js App Router
│   ├── learn/         # Module học tập & Dashboard
│   ├── roleplay/      # Module hội thoại AI
│   └── api/           # API Routes (AI Analysis, Roleplay)
├── components/        # Reusable UI Components
├── lib/               # AI Config, DB Connection, Utils
└── prisma/            # Database Schema`

export default function JapalyzeCaseStudy() {
  useEffect(() => {
    document.title = 'Japalyze - AI Japanese Assistant | Case Study'
    return () => {
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-10 py-12 flex flex-col md:flex-row gap-12">
        <aside className="hidden md:flex flex-col w-48 shrink-0 sticky top-28 h-fit">
          ...
          <nav className="flex flex-col space-y-1">
            ...
            <a href="#problem" className="text-sm text-slate-400 hover:text-white py-1.5 border-l-2 border-transparent pl-3">
              Vấn đề
            </a>
            <a href="#solution" className="text-sm text-slate-400 hover:text-white py-1.5 border-l-2 border-transparent pl-3">
              Giải pháp
            </a>
            <a href="#architecture" className="text-sm text-slate-400 hover:text-white py-1.5 border-l-2 border-transparent pl-3">
              Kiến trúc dự án
            </a>
          </nav>
        ...
        <main className="flex-1 min-w-0 flex flex-col gap-16 md:gap-20">
          ...
          <section className="flex flex-col gap-6 animate-fade-in" id="overview">
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 text-xs font-semibold uppercase tracking-wider">
                AI EdTech
              </span>
            ...
            <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tight text-white">
              Japalyze – AI Japanese Assistant
            </h1>
            <p className="text-xl text-slate-400 font-light leading-relaxed max-w-2xl">
              Ứng dụng phân tích và học tiếng Nhật thế hệ mới sử dụng Next.js App Router và OpenAI.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-6 bg-[#182430] rounded-xl border border-white/5">
              <div className="flex flex-col gap-1">
                ...
                <span className="font-medium text-slate-200 text-sm">
                  Next.js, OpenAI API, Prisma, Tailwind CSS, Vercel
                </span>
              </div>
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-[#182430] border border-white/5">
              <img
                ...
                alt="Japalyze - AI & neural networks"
          ...
          {/* The Problem */}
          <section className="pt-8 border-t border-slate-700/50" id="problem">
            ...
            <p className="text-slate-400 leading-relaxed max-w-3xl">
              Người học thường gặp khó khăn khi không có người luyện nói cùng (Role-play) hoặc tốn thời gian tạo
              Flashcard thủ công. Các công cụ dịch thuật thông thường không giải thích sâu về ngữ pháp/ngữ cảnh.
            </p>
          </section>
          ...
          <section className="pt-8 border-t border-slate-700/50" id="architecture">
            <div className="flex items-center gap-2 text-primary font-bold tracking-wide text-sm uppercase mb-4">
              <span className="w-8 h-[2px] bg-primary" />
              03. Kiến trúc dự án
            </div>
            ...
            <p className="text-slate-400 leading-relaxed mb-4 max-w-3xl">
              Cấu trúc thư mục rõ ràng với Next.js App Router, tách module học tập, roleplay và API.
            </p>
            <pre className="p-5 rounded-xl bg-[#0d141b] border border-slate-700 font-mono text-sm text-slate-300 overflow-x-auto whitespace-pre leading-relaxed">
              {folderStructure}
            </pre>
          </section>
          ...
          <div className="flex justify-between items-center pt-8 border-t border-slate-700/50">
            ...
            <Link to="/work/ong-hut-co-bang" className="text-slate-400 hover:text-primary flex items-center gap-2 text-sm">
              Ong Hut Co Bang
